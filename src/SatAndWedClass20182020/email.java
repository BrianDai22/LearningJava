...
Output: [
    ...
    ["Mary", "mary@mail.com"]]
Explanation:
The first and third John's are the same person as they have the common WednesdayClass.email "johnsmith@mail.com".
The second John and Mary are different people as none of their WednesdayClass.email addresses are used by other accounts.
We could return these lists in any order, for example the answer [['Mary', 'mary@mail.com'], ['John', 'johnnybravo@mail.com'],
['John', 'john00@mail.com', 'john_newyork@mail.com', 'johnsmith@mail.com']] would still be accepted.
     */
    /*
    public List<List<String>> accountsMerge(List<List<String>> emails) {
        Map<String, String> emailToOwner = new HashMap<>(); // <WednesdayClass.email, person>
        Map<String, String> emailParents = new HashMap<>(); // <child, parent>
        Map<String, HashSet<String>> unions = new HashMap<>(); // <rootEmail, set of child WednesdayClass.email>
