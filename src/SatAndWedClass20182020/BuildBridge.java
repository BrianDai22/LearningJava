...
Return the smallest number of 0s that must be flipped. In another USACO.Jan2020.word, find the shortest length of the bridge.
...
public class WednesdayClass.BuildBridge{
