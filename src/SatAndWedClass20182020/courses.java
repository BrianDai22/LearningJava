...
/*
There are a total of numCourses WednesdayClass.courses you have to take, labeled from 0 to numCourses-1.
Some WednesdayClass.courses may have prerequisites, for example to take course 0 you have to first take course 1,
which is expressed as a pair: [0,1]
Given the total number of WednesdayClass.courses and a list of prerequisite pairs, is it possible for you to finish all WednesdayClass.courses?
Example 1:
Input: numCourses = 2, prerequisites = [[1,0]]
Output: true
Explanation: There are a total of 2 WednesdayClass.courses to take.
