...
public class word {
    public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < words; i++) {
            //checks if word has more characters than allowed, if yes, than adds word and continues,
            // if no, than keeps on adding new words to original word
            ...
            if(i == 0) {
                ...
                //if not than adds word with space if the if statement above was able to pass
                temp += " " + eachWord[i];
            }
        }
        //finish adding words
