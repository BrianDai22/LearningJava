...
UserInfoDriver.Java
Author: Brian Dai
Driver class that will be used to run UserInfo
 */
import javax.swing.*; //import to use JOptionPane

public class UserInfoDriver { //creation of public class for UserInfoDriver
    public static void main(String[] args) { //main method to run UserInfo
        //create new object to be able to use the UserInfo class
