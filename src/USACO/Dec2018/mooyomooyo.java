...
public class mooyomooyo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader f = new BufferedReader(new FileReader("USACO.Dec2018.mooyomooyo.in"));
        // input file name goes above
        PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("USACO.Dec2018.mooyomooyo.out")));
