...
public class comfortable {
    public static void main(String[] args) throws IOException {
        ...
        //BufferedReader f = new BufferedReader(new FileReader("USACO.Feb2021.comfortable.in"));
        BufferedReader f = new BufferedReader(new InputStreamReader(System.in));
        // input file name goes above
        PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("USACO.Feb2021.comfortable.out")));
