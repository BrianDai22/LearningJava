...
public class crosswords {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader f = new BufferedReader(new FileReader("USACO.Dec2014.crosswords.in"));
        // input file name goes above
        PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("USACO.Dec2014.crosswords.out")));
