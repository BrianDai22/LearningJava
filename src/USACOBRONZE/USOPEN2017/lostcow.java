package USACOBRONZE.USOPEN2017;
...
print steps
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader f = new BufferedReader(new FileReader("USACO.USOPEN2017.lostcow.in"));
        // input file name goes above
        PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("USACO.USOPEN2017.lostcow.out")));
