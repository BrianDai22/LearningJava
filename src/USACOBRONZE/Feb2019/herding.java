...
public class herding {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader f = new BufferedReader(new FileReader("USACO.Feb2019.herding.in"));
        // input file name goes above
        PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("USACO.Feb2019.herding.out")));
