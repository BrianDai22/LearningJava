...
* [1, 4, 5, 6...] final state
*
* // find out how many cycles from init state to init state under the USACO.Feb2020.swap
*
* 1. create init sorted array
* 2. have counter and loop USACO.Feb2020.swap
* 3. check if you are sorted, yes? keep counter, No? counter++,then keep USACO.Feb2020.swap
*
* k = k % cycle
*
* USACO.Feb2020.swap k times, return result
*
* */
