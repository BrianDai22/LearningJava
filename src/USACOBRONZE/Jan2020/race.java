...
public class race {
    public static void main(String[] args) throws IOException {
        ...
        PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("USACO.Jan2020.race.out")));
        ...
        2 case:
            1. curSpeed < speedLimit
                keep adding speedUpDist and check totalDist with USACO.Jan2020.race length, no worry about slowDownDist
            2. curSpeed >= speedLimit
                for the speed, 1 sec speed up, and 1 sec to slow down
                need to update speedUpDist and slowDownDist; and check totalDist with USACO.Jan2020.race length
