...
public class guess {
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("USACO.Jan2019.guess.in"));
        PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("USACO.Jan2019.guess.out")));
