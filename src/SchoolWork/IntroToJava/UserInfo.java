...
public class UserInfo { //creation of public class for SchoolWork.IntroToJava.UserInfo
    ...
    public String swapHalfsForEncrypt(String password) { //USACO.Feb2020.swap the halves of the password with each other e.g. 1 2 = 2 1
        ...
        //USACO.Feb2020.swap the halves and put result into halfResult to be stored and returned
        halfResult = secondHalf + firstHalf;
        //return modified password
        return halfResult;
    }

    public String swapFirst2WithLast2(String password) { //USACO.Feb2020.swap the position of first two characters in password with the position of last two characters in password
        //initialize variable to hold result of the USACO.Feb2020.swap
        ...
        //USACO.Feb2020.swap the first two and last two character positions and store into firstLastResult
        firstLastResult = secondTwo + middle + firstTwo;
        //return modified password
        return firstLastResult;
    }

    public String swapMiddleChars(String password) { //USACO.Feb2020.swap middle chars positioning in password by taking four middle chars and swapping the first two and second two positions
        //initialize variable to hold result
        ...
        //USACO.Feb2020.swap middle chars in password and store into middleCharsResult
